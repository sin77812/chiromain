  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        <h2 
          ref={titleRef}
          className="absolute left-1/2 -translate-x-1/2 top-[12vh] text-h1 lg:text-display font-thin tracking-tighter leading-none text-void-black text-center korean will-change-transform px-md"
        >
